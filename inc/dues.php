<section class="contrast">
	<h2>Player Dues</h2>
    <p> NOVA is supported by our proud sponsors, but each player must also donate each season. Spring 2014 dues are <b>$150</b> for
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank"> 
        ...
        <p>
            <input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-but6.gif" name="submit" alt="PayPal for Player Dues"> 
        </p>
    </form>
